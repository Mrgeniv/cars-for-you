...
export const BMW_VARIANTS_ARRAY: Array<string> = [ 'Z4','4er']
export const FIAT_VARIANTS_ARRAY: Array<string> = []
export const OPEL_VARIANTS_ARRAY: Array<string> = ['X']
export const HYUNDAI_VARIANTS_ARRAY: Array<string> = ['30']
export const TESLA_VARIANTS_ARRAY: Array<string> = ['Y', '3']
export const POLESTAR_VARIANTS_ARRAY: Array<string> = ['Standard']
export const MG_VARIANTS_ARRAY: Array<string> = []
export const LYNKCO_VARIANTS_ARRAY: Array<string> = []
...
export const BMW_SERIES_ARRAY: Array<SeriesType> = [{seriesId: BMW_SERIES_ENUM.Z4, variants: BMW_VARIANTS_ARRAY },{seriesId: BMW_SERIES_ENUM.VIERER, variants: BMW_VARIANTS_ARRAY }, {seriesId: BMW_SERIES_ENUM.FUENFER, variants: BMW_VARIANTS_ARRAY }]
export const FIAT_SERIES_ARRAY: Array<SeriesType> = [{seriesId: FIAT_SERIES_ENUM.FUENFHUNDERT, variants: FIAT_VARIANTS_ARRAY}]
export const OPEL_SERIESARRAY: Array<SeriesType> = [{seriesId: OPEL_SERIES_ENUM.CROSSLAND, variants: OPEL_VARIANTS_ARRAY}]
export const HYUNDAI_SERIES_ARRAY: Array<SeriesType> = [{seriesId: HYUNDAI_SERIES_ENUM.I, variants: HYUNDAI_VARIANTS_ARRAY}]
export const TESLA_SERIES_ARRAY: Array<SeriesType> = [{seriesId: TESLA_SERIES_ENUM.MODEL, variants: TESLA_VARIANTS_ARRAY}]
export const POLESTAR_SERIES_ARRAY: Array<SeriesType> = [{seriesId: POLESTAR_SERIES_ENUM.ZWEI, variants: POLESTAR_VARIANTS_ARRAY}]
export const MG_SERIES_ARRAY: Array<SeriesType> = [{seriesId: MG_SERIES_ENUM.EHS, variants: MG_VARIANTS_ARRAY }]
export const LYNKCO_SERIES_ARRAY: Array<SeriesType> = [{seriesId: LYNKCO_SERIES_ENUM.NULLEINS, variants: LYNKCO_VARIANTS_ARRAY}]
